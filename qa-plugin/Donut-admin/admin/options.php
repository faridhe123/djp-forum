<?php
    ...
    function donut_default_option( $name )
    {
        $fixed_defaults = array(
            ...
            'donut_banner_div1_link'             => '#',
            'donut_banner_div1_img'              => 'https://cdn-wordpress-info.futurelearn.com/info/wp-content/uploads/how-does-the-economy-work.jpg',
            'donut_banner_div2_text'             => donut_lang( 'one_destination' ),
            'donut_banner_div2_link'             => '#',
            'donut_banner_div2_img'              => 'https://study.com/cimages/videopreview/videopreview-full/what-is-economy-definition-types-quiz_113903.jpg',
            'donut_banner_div3_text'             => donut_lang( 'get_expert_answers' ),
            'donut_banner_div3_link'             => '#',
            'donut_banner_div3_img'             => 'https://www.ashianahousing.com/real-estate-blog/wp-content/uploads/2021/01/Desktop-Banner.jpg',
    ...
    function donut_get_all_options()
    {
        return array(
            ...
            'donut_banner_div1_link',
            'donut_banner_div1_img',
            'donut_banner_div2_text',
            'donut_banner_div2_link',
            'donut_banner_div2_img',
            'donut_banner_div3_text',
            'donut_banner_div3_link',
            'donut_banner_div3_img',
