...
define('QA_MYSQL_HOSTNAME', '10.254.208.134');
...
define('QA_BLOBS_DIRECTORY', $_SERVER['DOCUMENT_ROOT'] . '/djp-forum/qa-uploaded-files-101/');
...
define('SSO_DJP', 'http://10.254.208.134:8081');
define('IAM_DJP', 'http://10.244.66.37');
